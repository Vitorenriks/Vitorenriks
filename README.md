...
Desenvolvedor Python com projeto real em produção e base sólida em fundamentos da computação pelo **CS50x da Harvard University**.

Minha trajetória é diferente: antes de migrar para o desenvolvimento, atuei anos no setor operacional gerenciando software corporativo, treinando equipes e resolvendo problemas de negócio. Hoje aplico essa visão no código — entendo o problema antes de escrever a primeira linha.

Atualmente aprofundando lógica de programação e estruturas de dados, com foco em boas práticas e arquitetura de software.
